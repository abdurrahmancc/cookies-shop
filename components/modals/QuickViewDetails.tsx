...
const QuickViewDetails = ({ product }: Props) => {
  ...
  return (
    <div className="flex 2xl:gap-[60px] gap-8 xl:flex-row flex-col">
      <Image
        src={`${product?.img}`}
        width={685}
        height={628}
        alt="product image"
        className="2xl:w-[618.46px] xl:w-[500] 2xl:h-[567px] h-auto"
      />
      ...
      <div>
        ...
        <h2 className="text-[34px] mt-[16px] mb-[20px] leading-10 font-[500] text-primary">
          {product?.name}
        </h2>
        <Rating width="w-[25.54px]" height="h-[21.8px]" />
        <p className="text-[32px] font-[500] my-[20px] text-primary leading-10">
          ${product?.price}
        </p>
        ...
        <div className="flex my-[20px] gap-5">
        ...
        <div className="flex mt-[20px] gap-[9px] items-center">
