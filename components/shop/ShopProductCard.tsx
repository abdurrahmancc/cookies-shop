...
const ShopProductCard = ({ product }: Prod) => {
      ...
      >
        ...
        <div className=" flex justify-center">
          ...
          >
            ...
            <div className="bg-white hover:bg-primary hover:text-white duration-300 transition-all cursor-pointer ease-in-out w-[38px] h-[31px] flex justify-center items-center  rounded-[4px] text-primary">
