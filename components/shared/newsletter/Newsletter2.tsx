...
import mail from "../../../assets/icons/mail-2.svg";

const Newsletter2 = () => {
  return (
    <div
      style={{ backgroundImage: `url(${bg.src})` }}
      className={"bg-no-repeat bg-cover box-border bg-[#944A07] w-full h-[287px]"}
    >
      <div className="max-w-[1200px] lg:mx-auto mx-5 h-full">
        <div className="flex h-full justify-between items-center">
          <div className="flex max-w-[592px] items-center gap-7">
            ...
            <h4 className="text-white lg:text-[30px] md:text-2xl text-xl font-[500] lg:leading-10 max-w-[610px] ">
          ...
          <div className="form-control max-h-[69px] w-full max-w-[529.32px] relative">
            <input
              ...
              className=" lg:text-[20px]  sm:text-xl leading-[28px] lg:h-[69px] h-[58px] sm:h-[68px] w-full rounded-[53px] pl-7 focus:outline-none text-[#944A07] placeholder:text-[rgba(0,0,0,0.7)] border border-[#ffffff] bg-[#ffffff]"
            />
